...
let ItemService = class ItemService {
    ...
    getItems() {
        ...
        return this.db.collection('users/' + this.userId + '/mascotas').snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(snaps => snaps.map(snap => (Object.assign({ itemId: snap.payload.doc.id }, snap.payload.doc.data())))));
    }
    deleteItemById(id) {
