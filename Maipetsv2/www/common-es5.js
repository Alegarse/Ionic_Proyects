...
var ItemService = /** @class */ (function () {
    function ItemService(db, authService) {
        var _this = this;
        this.db = db;
    ...
    ItemService.prototype.addItem = function (mascota) {
        // return this.db.collection('item').add(item);
        return this.db.collection('users/' + this.userId + '/mascotas').add(mascota);
    };
    ItemService.prototype.getItems = function () {
        // return this.db.collection<Item>('item').snapshotChanges()
        return this.db.collection('users/' + this.userId + '/mascotas').snapshotChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (snaps) { return snaps.map(function (snap) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ itemId: snap.payload.doc.id }, snap.payload.doc.data())); }); }));
    };
    ...
    ItemService.prototype.getItemById = function (id) {
        ...
        return this.db.collection('users/' + this.userId + '/mascotas').doc(id).valueChanges();
    };
    ItemService.prototype.updateItemById = function (id, mascota) {
