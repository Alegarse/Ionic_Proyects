...
module.exports = "<ion-app>\n  <!-- Parael menú que sale en todas las páginas de la app-->\n  <app-menu></app-menu>\n  <ion-router-outlet id=\"main\"></ion-router-outlet>\n</ion-app>\n"
...
var routes = [
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ path: 'list', loadChildren: function () { return Promise.all(/*! import() | pages-list-list-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-list-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/list/list.module */ "./src/app/pages/list/list.module.ts"))
            .then(function (m) { return m.ListPageModule; }); } }, Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["canActivate"])(Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectUnauthorizedTo"])(['login']))),
    {
        path: 'create-item',
    ...
    {
        path: 'not-found',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-not-found-not-found-module */ "pages-not-found-not-found-module").then(__webpack_require__.bind(null, /*! ./pages/not-found/not-found.module */ "./src/app/pages/not-found/not-found.module.ts")).then(function (m) { return m.NotFoundPageModule; }); }
    },
    {
        path: 'login',
    ...
    {
        path: 'reset-password',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-reset-password-reset-password-module */ "pages-reset-password-reset-password-module").then(__webpack_require__.bind(null, /*! ./pages/reset-password/reset-password.module */ "./src/app/pages/reset-password/reset-password.module.ts")).then(function (m) { return m.ResetPasswordPageModule; }); }
    },
    {
        path: 'info',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-info-info-module */ "pages-info-info-module").then(__webpack_require__.bind(null, /*! ./pages/info/info.module */ "./src/app/pages/info/info.module.ts")).then(function (m) { return m.InfoPageModule; }); }
    },
    {
        path: 'perfil',
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyBIBJZqoXWbwmzYlidsD0kd1YVh9f7FYII",
        authDomain: "maipetsionic.firebaseapp.com",
        databaseURL: "https://maipetsionic.firebaseio.com",
        projectId: "maipetsionic",
        storageBucket: "maipetsionic.appspot.com",
        messagingSenderId: "35759400996",
        appId: "1:35759400996:web:db9e89764381727f4610b1"
    }
    /*
      firebaseConfig : {
        apiKey: "AIzaSyDVwU-o7f7WeCnVtDy6pekZVA4UbBsAIWE",
        authDomain: "shopping-list-clase.firebaseapp.com",
        databaseURL: "https://shopping-list-clase.firebaseio.com",
        projectId: "shopping-list-clase",
        storageBucket: "shopping-list-clase.appspot.com",
        messagingSenderId: "899100048687",
        appId: "1:899100048687:web:954fed37769637a5beb5da"
      }
    */
};
/*
...
module.exports = __webpack_require__(/*! D:\FPIDAM\2DAM\AD\Proyectos Ionic\Maipetsv2\src\main.ts */"./src/main.ts");
