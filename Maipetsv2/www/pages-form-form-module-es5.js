...
var FormPage = /** @class */ (function () {
    function FormPage(itemService, router, activatedRoute, afs, storage) {
    ...
    FormPage.prototype.ngOnInit = function () {
        ...
        if (this.id != null) {
            this.itemService.getItemById(this.id).subscribe(function (data) {
                _this.mascota = data;
                _this.pageTitle = "Editar mascota";
                _this.action = "Actualizar mascota";
            });
        }
    };
    FormPage.prototype.addItem = function () {
    ...
    FormPage.prototype.onUpload = function (event) {
        var _this = this;
        this.loading = true;
        if (event.target.files && event.target.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                console.log(fileraw);
                var idf = Math.random().toString(36).substring(2);
                var filePath = "uploads/file_" + idf;
    ...
    FormPage.prototype.SaveImageRef = function (filePath, file) {
        return {
