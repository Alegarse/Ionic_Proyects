...
const routes = [
    ...
    Object.assign({ path: 'list', loadChildren: () => Promise.all(/*! import() | pages-list-list-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-list-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/list/list.module */ "./src/app/pages/list/list.module.ts"))
            .then(m => m.ListPageModule) }, Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["canActivate"])(Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectUnauthorizedTo"])(['login']))),
    {
        path: 'create-item',
        loadChildren: () => Promise.all(/*! import() | pages-form-form-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-form-form-module")]).then(__webpack_require__.bind(null, /*! ./pages/form/form.module */ "./src/app/pages/form/form.module.ts")).then(m => m.FormPageModule)
    },
    {
        path: 'edit-item/:id',
        loadChildren: () => Promise.all(/*! import() | pages-form-form-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-form-form-module")]).then(__webpack_require__.bind(null, /*! ./pages/form/form.module */ "./src/app/pages/form/form.module.ts")).then(m => m.FormPageModule)
    ...
    {
        path: 'not-found',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-not-found-not-found-module */ "pages-not-found-not-found-module").then(__webpack_require__.bind(null, /*! ./pages/not-found/not-found.module */ "./src/app/pages/not-found/not-found.module.ts")).then(m => m.NotFoundPageModule)
    },
    {
        path: 'login',
