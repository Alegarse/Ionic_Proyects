...
var ListPage = /** @class */ (function () {
    function ListPage(itemService, router, authService, alertController) {
    ...
    ListPage.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getCurrentUser().subscribe(function () { return _this.mascotas = _this.itemService.getItems(); });
    };
    ListPage.prototype.addItem = function () {
        this.router.navigateByUrl('/create-item');
    };
    ListPage.prototype.goEditItem = function (id) {
        this.router.navigateByUrl('/edit-item/' + id);
    };
    // Aviso de cofirmación para borrado
    ListPage.prototype.presentAlertConfirm = function (id, nombre) {
                            ...
                            buttons: [
                                {
                                    ...
                                    text: 'Si',
                                    handler: function () { return _this.itemService.deleteItemById(id); }
                                }
                            ]
                        })];
                    case 1:
